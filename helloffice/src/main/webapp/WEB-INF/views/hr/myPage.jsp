							...
							<div class="navbar_content">
								...
								<div class="navbar_btn_r">
									<button type="button" class="btn btn-light rounded-pill">
										<a href="sendingInvite" class="a_tag"><i class="bi bi-pencil-fill"></i> 정보 수정하기 </a>
									</button>
								</div>
							</div>
						</div>
                                    ...
                                    <div class="margin-div">
                                        <div class="section profile outer-wrapper">
                                            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
                                                ...
                                                <div class="align-items-center">${loginEmp.empName}</div>
                                                <div class="align-items-center"><span>${loginEmp.empRank} | ${loginEmp.empPosition}</span></div>
                                                            ...
                                                            <div>
                                                                <div class="profile-overview" id="profile-overview">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.depNo} </div>
                                                                    </div>
                                                
                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">역할</div>
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.empPosition} </div>
                                                                    </div>
                                                
                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">입사일</div>
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.entryDate}</div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9 col-md-8">${loginEmp.email}</div>
                                                                    </div>
                                                
                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">이름</div>
                                                                        <div class="col-lg-9 col-md-8">${loginEmp.empName}</div>
                                                                    </div>
                                                
                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">내 소개</div>
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.empInfo} </div>
                                                                    </div>

                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">휴대전화</div>
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.phone} </div>
                                                                    </div>

                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">주민등록번호</div>
                                                                        <div class="col-lg-9 col-md-8">${loginEmp.resiNo}/div>
                                                                    </div>

                                                                    <div class="row">
                                                                        <div class="col-lg-3 col-md-4 label">집 주소</div>
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.address} </div>
                                                                    </div>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9 col-md-8"> ${loginEmp.dependentNum} 명 </div>
                                                                    </div>
                                                            ...
                                                            <div>
                                                                <div class="profile-overview" id="profile-overview">
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-lg-9 col-md-8"> 해당사항없음 </div>
                                                                    </div>
